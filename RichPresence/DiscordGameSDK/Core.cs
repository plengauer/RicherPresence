...
namespace Discord
{
    ...
    public partial class Discord : IDisposable
    {
        ...
        private static void SetLogHookCallbackImpl(IntPtr ptr, LogLevel level, string message)
        {
            ...
            if (callback != null) callback(level, message);
        }
    ...
    public partial class ActivityManager
    {
        ...
        private static FFIMethods.UpdateActivityCallback staticUpdateActivityCallback = UpdateActivityCallbackImpl;

        public void UpdateActivity(Activity activity, UpdateActivityHandler callback)
        {
            Methods.UpdateActivity(MethodsPtr, ref activity, GCHandle.ToIntPtr(GCHandle.Alloc(callback)), staticUpdateActivityCallback);
        }
        ...
        private static FFIMethods.ClearActivityCallback staticClearActivityCallback = ClearActivityCallbackImpl;

        public void ClearActivity(ClearActivityHandler callback)
        {
            Methods.ClearActivity(MethodsPtr, GCHandle.ToIntPtr(GCHandle.Alloc(callback)), staticClearActivityCallback);
        }
